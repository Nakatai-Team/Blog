    ...
    <div class="posts-list-item">
        ...
        <p class="post-info-list">
            <span v-if="post.top" class="post-info-item">
                <IconInfo type="top" :title="$themeConfig.lang.top">
                    {{ $themeConfig.lang.top }}
                </IconInfo>
            </span>

            <span v-if="post.createdAt" class="post-info-item">
                <IconInfo type="date" :title="post.createdAt">
                    {{ post.createdAt }}
                </IconInfo>
            </span>
            ...
            <span v-if="post.category" class="post-info-item">
                <RouterLink :to="$categories.getItemByName(post.category).path">
                    <IconInfo type="category" :title="post.category">
                        {{ post.category }}
                    </IconInfo>
                </RouterLink>
            </span>
            ...
            <span v-if="post.tags.length" class="post-info-item">
                <IconInfo type="tags">
                    <RouterLink v-for="(tag, i) in post.tags" :key="tag" :to="$tags.getItemByName(tag).path"
                        :title="tag">
